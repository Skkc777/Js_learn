...
// // console.log(btns);     //обращение к кнопка за счет переменной, 
// обращение происходит за счет псевдомассива [0,1,2,3,4];
...
//div.innerHTML = 'Hello World'; // помещает во внутрь созданного div текстовую структуру 
//                                                           ВАЖНО ТОЛЬКО ДЛЯ РАЗРАБОТЧИКА САЙТА!
...
//hearts = document.querySelectorAll('.heart'); // здесь указание что поиск идет по всей странице html, но можно указать
//                                                                                                в каком
...
// const hearts = wrapper.querySelectorAll('.heart'); 
                     // здесь указано что поиск идет в селекторе Wrapper и ищем мы heart
